	...
	if(isset($_POST['submit']) && $qCheck == false && $sCheck == false)
		{
			...
			if(!mysql_query("INSERT INTO arrow (quote, name)
...
<body background="img/bg/arrow.jpg" style="background-size:100%">
<br><br><br>
<td style = 'text-align:center;'>
		<h1><b>Quote Mine</b><u>Quote Mine</u></h1>
	</td>
	<form action = "arrow.php" method = "post">
	Quote
	<textarea placeholder="Enter Quotes Here..." name = "quote" cols = "40" rows = "6" ><?php  if($qCheck) echo "Enter a quote"; ?></textarea></br></br>
	Name
	<input type = "text" name = "name"><?php if($sCheck) echo "Enter a name"; ?></br><br>
